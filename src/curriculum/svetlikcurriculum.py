...
class SvetlikCurriculum(Curriculum):
    ...
    def generate_curriculum(self,target_task, sourceFolder,workFolder,thresholdTask = 0.5):
    ...
    def generate_curriculum_from_tasks(self,target_task, taskList,thresholdTask = 0.5):
        """ The Curriculum is generated by this function (stored internally) """
