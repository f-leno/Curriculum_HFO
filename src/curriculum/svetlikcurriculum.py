...
class SvetlikCurriculum(Curriculum):
    ...
    def generate_curriculum(self,target_task, sourceFolder,workFolder,thresholdTask = 0.75):
    ...
    def generate_curriculum_from_tasks(self,target_task, taskList,thresholdTask = 0.75):
        """ The Curriculum is generated by this function (stored internally) """
    ...
    def transfer_potential(self,currentTask,target_task,curriculumTasks):
        return currentTask.transfer_potential(target_task)
